...
var Doomsday = function Doomsday(_ref) {
  ...
  var renderUnit = function renderUnit(type) {
    ...
    }) : showDefaults && createElement("div", {
      style: {
        margin: '0 4px'
      }
    }, createElement("span", null, doomsday.endOfTimeSequence[type], " "), createElement("span", null, doomsday.endOfTimeSequence[type] === 1 ? type.slice(0, -1) : type));
  };
  ...
  if (isHere) return createElement("div", Object.assign({
    style: styles
  }, div), props.goodbye);
  if (props.render && !renderAll) return createElement("div", Object.assign({
    style: styles
  }, div), render);
