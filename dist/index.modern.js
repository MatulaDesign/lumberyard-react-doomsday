...
function useDoomsday(date, play) {
  var doom = useMemo(function () {
    return createDoomsdate(date);
  }, [date]);

  var _React$useState = useState(doom),
      doomsday = _React$useState[0],
      setDoomsday = _React$useState[1];

  var _React$useState2 = useState(doomsday.endOfTime.seconds),
  ...
  var refresh = useCallback(function (now) {
...
var Doomsday = function Doomsday(_ref) {
  ...
  var renderUnit = function renderUnit(type) {
    ...
    }) : showDefaults && createElement("div", null, createElement("div", null, doomsday.endOfSequence[type]), createElement("div", null, doomsday.endOfSequence[type] === 1 ? type.slice(0, -1) : type));
  };
  ...
  if (isFinished) return createElement("div", Object.assign({}, div), props.finish);
  if (props.render) return createElement("div", Object.assign({}, div), renderAll);
  return createElement("div", Object.assign({}, div), renderYears, renderMonths, renderDays, renderHours, renderMinutes, renderSeconds);
};
